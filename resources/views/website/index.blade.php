...
<body class="index-page">
      ...
      <div class="container">
        ...
        <div class="row gy-4 gx-5">
          ...
          <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="200">
            ...
            <a href="https://www.youtube.com/watch?v=umNHXduPCtI&t=47s" class="glightbox pulsating-play-btn"></a>
          </div>
        ...
        <div class="row">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              <li class="nav-item">
                <a class="nav-link active show" data-bs-toggle="tab" href="#departments-tab-1">Kesehatan Masyarakat</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-2">Gizi</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-3">Farmasi</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#departments-tab-4">Kedokteran Umum</a>
              </li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <h3>Location</h3>
                <p>UNNES Sekaran Kampus Kelud Semarang</p>
              </div>
            </div><!-- End Info Item -->
  ...
  <footer id="footer" class="footer light-background">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center">
            <span class="sitename">Medunnes</span>
          </a>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Medunnes</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
