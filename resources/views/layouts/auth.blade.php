  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Medunnes</span>
      </a>
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Jenis Pemeriksaan <span>| Today</span></h5>
        ...
        <!-- Revenue Card -->
            ...
            <div class="col-12">
              ...
              </table>warning: in the working copy of 'app/Http/Controllers/HomeController.php', CRLF will be replaced by LF the next time Git touches it
warning: in the working copy of 'resources/views/admin/mahasiswa.blade.php', CRLF will be replaced by LF the next time Git touches it 
warning: in the working copy of 'resources/views/layouts/auth.blade.php', CRLF will be replaced by LF the next time Git touches it    
